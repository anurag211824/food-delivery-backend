...
export class AddressesController {
  ...
  @ApiOperation({
    ...
    description:
      'Add a delivery address for the logged-in user. Supports GPS co-ordinates or a manually typed address.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Mark one address as the default delivery address. Clears the default flag on all other addresses first.',
  })
  @ApiParam({
    name: 'id',
    example: 'clxyz456',
  ...
  @ApiResponse({
    status: 403,
    description: 'Forbidden — this address does not belong to you',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Edit any field of a saved address. Only the address owner can update it.',
  })
  @ApiParam({
    name: 'id',
    example: 'clxyz456',
  ...
  @ApiOperation({
    ...
    description:
      'Permanently remove a saved address. You can only delete your own addresses.',
  })
  @ApiParam({
    name: 'id',
    example: 'clxyz456',
