...
export class PartnerRequestsController {
  ...
  @ApiOperation({
    ...
    description:
      'Any logged-in user can apply to become a restaurant partner. Submit the restaurant details — the admin will review and approve or reject the request. You can only have one active application.',
  })
  ...
  @ApiResponse({
    status: 409,
    description: 'You already have an existing application',
  })
  async submitRestaurantRequest(
    @Body() dto: CreateRestaurantRequestDto,
    @Req() req: AuthenticatedRequest,
  ) {
    return this.partnerRequestsService.submitRestaurantRequest(
      req.user.id,
      dto,
    );
  }
  ...
  @ApiOperation({
    ...
    description:
      'Check the current status of your restaurant partner application (PENDING, APPROVED, or REJECTED).',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    status: 404,
    description: 'No application found for your account',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Any logged-in user can apply to become a delivery partner. Submit your vehicle details — the admin will review and approve or reject the request.',
  })
  ...
  @ApiResponse({
    ...
    schema: {
      example: { id: 'dreq_123', status: 'PENDING', vehicleType: 'Bike' },
    },
  })
  @ApiResponse({
    status: 409,
  ...
  @ApiOperation({
    ...
    description:
      'Check the current status of your delivery partner application (PENDING, APPROVED, or REJECTED).',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Any logged-in user can apply to become a grocery store partner. Submit the store details — the admin will review and approve or reject the request. You can only have one active application.',
  })
  ...
  @ApiResponse({
    ...
    schema: {
      example: {
        id: 'sreq_123',
        status: 'PENDING',
        storeName: "Priya's Grocery Mart",
      },
    },
  })
  @ApiResponse({
  ...
  @ApiOperation({
    ...
    description:
      'Check the current status of your grocery store partner application (PENDING, APPROVED, or REJECTED).',
  })
  @ApiResponse({
    status: 200,
