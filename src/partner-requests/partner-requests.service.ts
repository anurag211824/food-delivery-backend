...
export class PartnerRequestsService {
  ...
  async getMyRestaurantRequest(userId: string) {
    ...
    if (!request) {
      throw new NotFoundException(
        'No restaurant application found for your account.',
      );
    }
    return request;
  }
  ...
  async getMyDeliveryRequest(userId: string) {
    ...
    if (!request) {
      throw new NotFoundException(
        'No delivery partner application found for your account.',
      );
    }
    return request;
  }
  ...
  async getMyStoreRequest(userId: string) {
    ...
    if (!request) {
      throw new NotFoundException(
        'No grocery store application found for your account.',
      );
    }
    return request;
  }
