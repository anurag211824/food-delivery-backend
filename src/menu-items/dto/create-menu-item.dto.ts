...
export class CreateAddonOptionDto {
  ...
  @ApiPropertyOptional({
    example: true,
    description: 'Is this addon available?',
  })
  @IsBoolean()
  @IsOptional()
  isAvailable?: boolean;
...
export class CreateAddonGroupDto {
  ...
  @ApiProperty({
    ...
    description: 'Options within this addon group',
  })
  @IsArray()
...
export class CreateMenuVariantDto {
  @ApiProperty({
    example: 'Regular',
    description: 'Variant name (Small, Medium, Large, Half, Full)',
  })
  @IsString()
  @IsNotEmpty()
  name: string;
  ...
  @ApiPropertyOptional({
    example: '8 inch',
    description: 'Quantity descriptor (250ml, 500g, 2 pcs)',
  })
  @IsString()
  @IsOptional()
  quantity?: string;
  ...
  @ApiPropertyOptional({
    example: 'Serves 1',
    description: 'Serving size descriptor',
  })
  @IsString()
  @IsOptional()
  servingSize?: string;
  ...
  @ApiPropertyOptional({
    example: true,
    description: 'Is this the default variant shown to customers?',
  })
  @IsBoolean()
  @IsOptional()
  isDefault?: boolean;
...
export class CreateMenuItemDto {
  ...
  @ApiPropertyOptional({
    example: 'Medium',
    description: 'Spice level (Mild, Medium, Hot)',
  })
  @IsString()
  @IsOptional()
  spiceLevel?: string;
  ...
  @ApiPropertyOptional({
    ...
    description:
      'Menu variants with pricing. If omitted, a default variant is created from the legacy `price` field.',
  })
  @IsArray()
  @ValidateNested({ each: true })
  @Type(() => CreateMenuVariantDto)
  ...
  @ApiPropertyOptional({
    example: 350,
    description:
      '(Legacy) Price — auto-creates a Default variant if `variants` is not provided',
  })
  @IsNumber()
  @Min(0)
  @IsOptional()
