...
export class MenuCategoriesController {
  ...
  @ApiOperation({
    ...
    description:
      'Add a new category (e.g., "Starters", "Main Course", "Drinks") to your restaurant menu. The restaurant is inferred from the logged-in manager.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Fetch all menu categories (with their items) for a specific restaurant. Used to build the menu page.',
  })
  @ApiParam({
    name: 'restaurantId',
    example: 'clxyz789',
  ...
  @ApiOperation({
    ...
    description:
      'Get all menu categories across all restaurants (admin/debug view).',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Remove a category and all its associated menu items permanently.',
  })
  @ApiParam({
    name: 'id',
    example: 'clcat123',
