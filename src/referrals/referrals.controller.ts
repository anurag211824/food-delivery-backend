...
export class ReferralsController {
  ...
  @Post('apply')
  @ApiOperation({ summary: 'Apply a friend\'s referral code for a wallet reward' })
  @ApiResponse({ status: 200, description: 'Code successfully applied, both users rewarded.' })
  @ApiResponse({ status: 400, description: 'Invalid code or trying to apply own code' })
  ...
  @Get('my-stats')
  @ApiOperation({ summary: 'Get your unique code and see how many people you referred' })
