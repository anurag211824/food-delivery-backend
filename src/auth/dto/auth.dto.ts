...
export class SignUpDto {
  ...
  @ApiPropertyOptional({
    example: true,
    description: 'Is the user vegetarian?',
  })
  @IsOptional()
  @IsBoolean()
  isVeg?: boolean;
  ...
  @ApiPropertyOptional({
    example: 'PRIYA123',
    description: 'Referral code from a friend',
  })
  @IsOptional()
  @IsString()
...
export class UpdateProfileDto {
  ...
  @ApiPropertyOptional({
    example: '1990-01-01',
    description: 'Date of Birth (YYYY-MM-DDT00:00:00.000Z)',
  })
  @IsOptional()
  @IsString()
  dob?: string;
  ...
  @ApiPropertyOptional({
    example: 'user@example.com',
    description: 'Email address (can only be set if currently missing)',
  })
  @IsOptional()
  @IsEmail()
  email?: string;
