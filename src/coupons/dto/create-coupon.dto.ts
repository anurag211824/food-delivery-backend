import { IsString, IsNotEmpty, IsNumber, IsOptional, IsEnum, IsDateString, IsBoolean, IsInt, Min } from 'class-validator';
...
export class CreateCouponDto {
    ...
    @ApiProperty({ example: 20, description: '20 means 20% off or ₹20 off depending on type' })
    @IsNumber()
    ...
    @ApiPropertyOptional({ example: 200, description: 'Minimum order amount to apply' })
    @IsOptional()
    @IsNumber()
    minOrder?: number;
