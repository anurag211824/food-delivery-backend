...
export class CouponsController {
  ...
  @ApiResponse({
    status: 200,
    description: 'List of valid coupons the user can apply',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Check if a coupon is valid for this user and order total. Returns the discount amount.',
  })
  @ApiBody({
    schema: {
      type: 'object',
  ...
  @ApiResponse({
    status: 400,
    description: 'Coupon is invalid, expired, or already used',
  })
  async validate(
