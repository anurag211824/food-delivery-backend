...
async function bootstrap() {
  ...
  // 3. Swagger Contract Definition - FIXED CHAINING
  const config = new DocumentBuilder()
    .setTitle('Food Delivery API')
    .setDescription('Core API contract for Customers, Restaurants, and Riders')
    .setVersion('1.0')
    .addTag('auth', 'Account & Profile logic')
    .addTag('addresses', 'Customer address management')
    .addTag('restaurants', 'Restaurant discovery and management')
    .addTag('menu', 'Categories and Food Items')
